    ...
    <div className="min-h-screen pt-24 pb-32 px-4 sm:px-12 max-w-7xl mx-auto flex flex-col gap-8">
      <div className="flex flex-col sm:flex-row justify-between items-end gap-6 border-b border-stone-800 pb-8">
        <div className="space-y-2">
          <h2 className="font-cinzel text-4xl font-black text-amber-500 uppercase tracking-tighter">Vos Archives</h2>
          <p className="text-stone-500 text-sm tracking-widest font-bold uppercase">Le Répertoire des Anciens</p>
        </div>
        ...
        <div className="flex gap-4 sm:gap-8 flex-wrap">
          ...
          <div className="text-center">
             ...
             <div className="text-[10px] text-stone-500 uppercase font-bold tracking-widest">Mythique</div>
          </div>
          <div className="text-center">
             <div className="text-xl font-black text-pink-500 font-cinzel">{stats.heroic}</div>
             <div className="text-[10px] text-stone-500 uppercase font-bold tracking-widest">Héroïque</div>
          </div>
          <div className="text-center">
             <div className="text-xl font-black text-purple-500 font-cinzel">{stats.epic}</div>
             <div className="text-[10px] text-stone-500 uppercase font-bold tracking-widest">Épique</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 items-center">
        <div className="relative group col-span-1 sm:col-span-2">
          ...
          <input 
            type="text" 
            placeholder="Rechercher par nom ou mythologie..."
      ...
      {filteredCollection.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-stone-600 gap-4">
          ...
          <p className="font-cinzel text-lg font-bold">Aucun Artéfact Trouvé</p>
          <p className="text-sm">Ajustez vos filtres ou visitez le temple.</p>
        </div>
      )}
    </div>
  );
